...
auth: state,
browser: [`bot by ${ownername}`, "Adelia-MD", "1.0.0"],
...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6285339189356@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6285339189356@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
item2.EMAIL;type=INTERNET:Marselhasagi12@gmail.com\n
...
"url": `https://youtube.com/channel/hasagi`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `6285339189356@s.whatsapp.net`
}
}, options)
