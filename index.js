...
const iswel = JSON.parse(fs.readFileSync('./database/welcome.json'))
...
} else if (connection === "open") { XeonBotInc.sendMessage(owner + "@s.whatsapp.net", { text: `*Bot started!*\n\n\nYouTube: https://youtube.com/@marselhasagi\n\nGitHub: https://github.com/marselhasagi\n\nInstsgram: https://instagram.com/marsel_hasagi24\n\nWhatsApp Pm: wa.me/6285339189356\n` }); }
