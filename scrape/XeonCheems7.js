...
if (!quoted) return XeonBotInc.reply(m.chat, `Fotonya Mana?`,m)
if (!/image/.test(mime)) return XeonBotInc.reply(m.chat,`Send/Reply Foto Dengan Caption ${prefix + command}`,m )
m.reply(mess.wait)
